...
<div class="card mb-10" id="daywiseOiCard">
  <div class="card-hd">
    <div class="card-title">Day-wise OI (Last 5 Days) <span class="muted small">Bias context</span></div>
      ...
      <table class="tbl tbl-compact" id="daywiseOiTbl">
        <thead>
          <tr>
            ...
            <th style="text-align:right">PCR (ATM±5)</th>
            <th style="text-align:right">WIN CE OI</th>
            <th style="text-align:right">WIN PE OI</th>
            <th style="text-align:right">ΔCE (VS D-1)</th>
            <th style="text-align:right">ΔPE (VS D-1)</th>
            <th style="text-align:right">STRONG CE</th>
            <th style="text-align:right">STRONG PE</th>
          </tr>
        </thead>
...
<div class="nse-oc-wrap size-normal" id="nseOcWrap">
  ...
  <div class="card-head" title="Click to expand/collapse">
    <div class="head-left"><b>Top OI Levels</b> <span class="muted small">All strikes + Near ATM</span></div><div class="head-right" style="gap:8px"><select id="topOiExpirySel" class="miniSel" title="Switch expiry for Top OI panel only"></select><span class="badge" id="top5ExpiryBadge" title="Expiry used for these levels">Expiry: --</span><span class="badge" id="wallBadgeCE" style="display:none" title="Largest CE wall within ±2 strikes">CE Wall</span><span class="badge" id="wallBadgePE" style="display:none" title="Largest PE wall within ±2 strikes">PE Wall</span></div>
    <span class="card-toggle" aria-hidden="true">▼</span>
  </div>
  <div class="card-body">
